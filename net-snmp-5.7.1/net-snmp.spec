...
install -m 755 net-snmp-config ${RPM_BUILD_ROOT}/%{_bindir}/net-snmp-config
mv ${RPM_BUILD_ROOT}/%{_includedir}/net-snmp/net-snmp-config.h ${RPM_BUILD_ROOT}/%{_includedir}/net-snmp/net-snmp-config-${basearch}.h
install -m644 net-snmp-config.h ${RPM_BUILD_ROOT}/%{_includedir}/net-snmp/net-snmp-config.h
%endif

install -d ${RPM_BUILD_ROOT}%{_sysconfdir}/snmp
install -m 644 net-snmp.redhat.conf ${RPM_BUILD_ROOT}%{_sysconfdir}/snmp/snmpd.conf
install -m 644 net-snmp-trapd.redhat.conf ${RPM_BUILD_ROOT}%{_sysconfdir}/snmp/snmptrapd.conf

install -d ${RPM_BUILD_ROOT}%{_initrddir}
install -m 755 net-snmpd.init ${RPM_BUILD_ROOT}%{_initrddir}/snmpd
install -m 755 net-snmptrapd.init ${RPM_BUILD_ROOT}%{_initrddir}/snmptrapd

install -d ${RPM_BUILD_ROOT}%{_sysconfdir}/sysconfig
install -m 644 net-snmpd.sysconfig ${RPM_BUILD_ROOT}%{_sysconfdir}/sysconfig/snmpd
install -m 644 net-snmptrapd.sysconfig ${RPM_BUILD_ROOT}%{_sysconfdir}/sysconfig/snmptrapd
...
install -m 644 net-snmp-tmpfs.conf $RPM_BUILD_ROOT/%{_sysconfdir}/tmpfiles.d/net-snmp.conf
install -m 755 -d $RPM_BUILD_ROOT/%{_unitdir}
install -m 644 snmpd.service snmptrapd.service $RPM_BUILD_ROOT/%{_unitdir}/
